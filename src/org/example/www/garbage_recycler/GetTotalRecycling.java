 ...
 */
            ...
            /**
            *  GetTotalRecycling bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class GetTotalRecycling
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":getTotalRecycling",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getTotalRecycling",
    ...
    public static class Factory{
        ...
        */
        public static GetTotalRecycling parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetTotalRecycling object =
                new GetTotalRecycling();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getTotalRecycling".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (GetTotalRecycling)org.example.www.garbage_recycler.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
